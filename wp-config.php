...
if (!defined('WP_ENV')) {
    ...
    include $CONFIG_PATH . 'wp-config.env.php';
}
...
// Load default config
include $CONFIG_PATH . 'wp-config.default.php';

// Load config file for current environment
include $CONFIG_PATH . 'wp-config.' . WP_ENV . '.php';
...
define( 'UPLOADS','assests/img' );
$upload_path =  __dir__.'/assests/img';
